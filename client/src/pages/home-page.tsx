...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      {/* Neugestaltete Eingabeformular-Karte - Eindeutige ID hinzugefügt */}
      <Card id="eingabeformular" className="mt-4 border-4 border-primary shadow-lg">
        <CardHeader className="bg-gradient-to-r from-primary/20 to-primary/5">
          <CardTitle className="text-3xl font-bold">Willkommen, {user?.name || user?.username}!</CardTitle>

              ...
              <div className="w-full max-w-lg flex md:ml-0">
                <TooltipButton tooltipText="Nach Projekten und Dokumenten suchen" side="bottom">
                  <div className="relative w-full text-gray-400">
                    ...
                    <input
                      className="block w-full h-full pl-10 pr-3 py-2 rounded-md border border-gray-300 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary"
                      placeholder="Suchen..."
                      value={searchQuery}
            ...
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <div className="flex items-center gap-2">
                <TooltipButton tooltipText="Benutzereinstellungen" side="bottom">
                  <div className="h-8 w-8 rounded-full bg-primary flex items-center justify-center text-white cursor-pointer">

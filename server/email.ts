    ...
    const emailData = {
      ...
      htmlContent: resetLink 
        ? `<html><body>
            ...
            <p>Mit freundlichen Grüßen<br>Ihr Bau - Structura App Team</p>
          </body></html>`
        : `<html><body>
            ...
            <p style="font-size: 24px; font-weight: bold; padding: 10px; background-color: #f4f4f4; display: inline-block;">${code}</p>
            <p>Dieser Code ist 30 Minuten lang gültig.</p>
            <p>Falls Sie sich nicht bei der Bau - Structura App angemeldet haben, können Sie diese E-Mail ignorieren.</p>
            <p>Mit freundlichen Grüßen<br>Ihr Bau - Structura App Team</p>
          </body></html>`,
    };
